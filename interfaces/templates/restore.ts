...
export interface IMethodRestoreOptions<M = any> extends IMethodBaseOptions {
  ...
  beforeRestore?: TMethodHookHandler<Omit<IMethodRestoreContextOptions<M>, 'instance'> & { instance: M }>
  afterRestore?: TMethodHookHandler<Omit<IMethodRestoreContextOptions<M>, 'instance'> & { instance: M }>
  sendStatus?: boolean
  response?: TMethodResponseHandlerWithContext<Omit<IMethodRestoreContextOptions<M>, 'instance'> & { instance: M }>
}
