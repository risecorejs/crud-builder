...
import { TMethodState, TMethodRules, TMethodOnly, TMethodHookHandler, TMethodResponseHandlerWithContext } from '../../types';
export interface IMethodCreateOptions<M = any> extends IMethodBaseOptions {
    ...
    afterCreate?: TMethodHookHandler<Omit<IMethodCreateContextOptions<M>, 'instance'> & {
        instance: M;
    }>;
    sendStatus?: boolean;
    response?: TMethodResponseHandlerWithContext<Omit<IMethodCreateContextOptions<M>, 'instance'> & {
        instance: M;
    }>;
}
