...
import { TMethodState, TMethodRules, TMethodOnly, TMethodHookHandler, CModel, TMethodResponseHandlerWithContext } from '../../types';
export interface IMethodCreateOptions extends IMethodBaseOptions {
    ...
    afterCreate?: TMethodHookHandler<Omit<IMethodCreateContextOptions, 'instance'> & {
        instance: CModel;
    }>;
    sendStatus?: boolean;
    response?: TMethodResponseHandlerWithContext<Omit<IMethodCreateContextOptions, 'instance'> & {
        instance: CModel;
    }>;
}
